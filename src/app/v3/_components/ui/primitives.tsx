...
/** Стекло премиума. Непрозрачная база обязательна — под панелью бывает
 *  карта или фото, на прозрачном текст пропадает. Значения вынесены в
 *  переменные v3.css: инлайновый стиль темой не переключить.
 *
 *  Запасные значения обязательны: полноэкранная карта уходит порталом в
 *  body, то есть за пределы .v3-scope, где переменных нет — без них панели
 *  там остались бы прозрачными. */
export const glassStyle: CSSProperties = {
  backdropFilter: "blur(18px) saturate(1.5)",
  background:
    "var(--v3-glass, linear-gradient(160deg, rgba(18,23,30,0.80), rgba(10,13,18,0.88)))",
  boxShadow:
    "var(--v3-glass-shadow, inset 0 1px 0 rgba(255,255,255,0.14), inset 0 -0.5px 0 rgba(255,255,255,0.05), 0 24px 60px -20px rgba(0,0,0,0.8))",
};
