...
export default function VillagesShowcase() {
  ...
  return (
    <section className="relative bg-gradient-to-b from-white via-stone-50 to-white py-20 sm:py-24 lg:py-32">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-3xl">
          ...
          <p className="mt-6 text-lg sm:text-xl text-stone-600 leading-relaxed font-medium">
          ...
          {items.map((v) => {
            ...
            return (
              <Link
                key={v.slug}
                href={`/village/${v.slug}`}
                className="group relative shrink-0 snap-start w-[78vw] sm:w-[58vw] md:w-[42vw] lg:w-[340px] xl:w-[380px] aspect-[4/5] rounded-3xl overflow-hidden bg-stone-200 shadow-lg hover:shadow-2xl hover:scale-[1.02] transition-all duration-500 ease-out ring-1 ring-stone-200"
              >
                {/* Cover photo */}
                ...
                <div className="absolute top-4 right-4 inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-white/95 backdrop-blur shadow-sm">
