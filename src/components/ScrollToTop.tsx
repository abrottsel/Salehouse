...
export default function ScrollToTop() {
  ...
  return (
    ...
    >
      ...
      <a
        href="#"
        onClick={(e) => { e.preventDefault(); alert("WhatsApp скоро будет подключён"); }}
        aria-label="WhatsApp"
        className="w-11 h-11 rounded-full bg-[#25D366] hover:bg-[#20BD5A] flex items-center justify-center shadow-xl shadow-black/15 hover:scale-110 active:scale-95 transition-all duration-200"
      >
        <svg className="w-5 h-5 text-white" viewBox="0 0 24 24" fill="currentColor">
