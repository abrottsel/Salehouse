export default function Logo({ className = "" }: { className?: string }) {
  return (
    <div className={`flex items-center gap-0.5 ${className}`}>
      <span className="text-xl font-extrabold text-gray-900 dark:text-white tracking-tight">Зем</span>
      ...
      <span className="text-xl font-extrabold text-gray-900 dark:text-white tracking-tight">Плюс</span>
    </div>
  );
}
