...
export default function FavoritesCounter({ variant = "compact" }: Props) {
  ...
  return (
    <a
      ...
      title="Избранное"
      className="relative inline-flex items-center justify-center w-9 h-9 rounded-full bg-gray-50 hover:bg-rose-50 border border-gray-200 hover:border-rose-200 text-gray-700 hover:text-rose-700 transition-all duration-200"
    >
      <Heart
        className={`w-4 h-4 transition-colors ${
          showBadge ? "fill-rose-500 text-rose-500" : ""
