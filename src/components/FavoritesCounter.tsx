...
export default function FavoritesCounter({ variant = "compact" }: Props) {
  ...
  return (
    <a
      ...
      title="Избранное"
      className="relative inline-flex items-center justify-center w-11 h-11 md:w-9 md:h-9 rounded-full hover:bg-gray-100 dark:hover:bg-white/10 text-gray-600 dark:text-gray-300 hover:text-rose-600 dark:hover:text-rose-400 transition-colors duration-200"
    >
      <Heart
        className={`w-4 h-4 transition-colors ${
          showBadge ? "fill-rose-500 text-rose-500" : ""
