        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-2.5 sm:gap-3 lg:gap-4 xl:gap-5">
          {tiles.map((tile) => (
            ...
            >
              ...
              <div className="text-white text-sm sm:text-base font-bold leading-tight drop-shadow-[0_1px_2px_rgba(0,0,0,0.4)]">
                {tile.title}
              </div>
              {tile.subtitle && (
                <div className="text-white/85 text-xs sm:text-sm font-medium mt-1 leading-snug drop-shadow-[0_1px_1px_rgba(0,0,0,0.3)]">
                  {tile.subtitle}
                </div>
              )}
