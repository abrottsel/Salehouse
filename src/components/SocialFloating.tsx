...
/**
 * SocialFloating — Telegram + MAX icons fixed bottom-left,
 * above the "Наверх" button, at the same level as "Подберу участок".
 */

export default function SocialFloating() {
  return (
    <div className="fixed right-5 bottom-[72px] z-40 flex items-center gap-2">
      {/* Telegram */}
      <a
