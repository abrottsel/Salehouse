  ...
  return (
    <div className="fixed right-[200px] sm:right-[220px] bottom-2 sm:bottom-3 z-40 flex items-center gap-2">
      ...
      <a
        ...
        aria-label="Telegram"
        className="w-11 h-11 rounded-2xl overflow-hidden shadow-lg shadow-[#2AABEE]/30 hover:scale-110 active:scale-95 transition-all duration-200 ring-1 ring-white/20 bg-white"
      >
